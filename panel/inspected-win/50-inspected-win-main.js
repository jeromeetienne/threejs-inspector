(function(){
        ...
        if( window.InspectedWin3js !== undefined ){
                console.log('in 50-injected_script-main.js: already injected, bailing out')
                return                
        }
        ...
        if( hasTHREEJS ){
        	console.log('in 50-injected_script-main.js: three.js is present version', THREE.REVISION)
        }else{
        	console.log('in 50-injected_script-main.js: three.js is NOT present. bailing out')
                return
        }
        ...
        InspectedWin3js.extractThreeJSClassNames	= function() {
                console.log('in 50-injected_script-main.js: extract three.js classnames')
        ...
        InspectedWin3js.ChangeProperty = function( object3dUUID, property, value ) {
        	console.log('in 50-injected_script-main.js: ChangeProperty', arguments)
        ...
        InspectedWin3js.ChangeObject3dFunction = function( object3dUUID, fct, args ){
        	console.log('in 50-injected_script-main.js: ChangeObject3dFunction', fct.toString(), args)
                var object3d = InspectedWin3js.getObjectByUuid(object3dUUID)
        ...
        console.log('in 50-injected_script-main.js: running stop')
})()
