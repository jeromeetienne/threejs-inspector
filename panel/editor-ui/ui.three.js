...
UI.Texture0.prototype = Object.create( UI.Element.prototype );

UI.Texture0.prototype.getValue = function () {

	return this.texture;

};

UI.Texture0.prototype.setValue = function ( texture ) {
...
UI.Texture0.prototype.onChange = function ( callback ) {
